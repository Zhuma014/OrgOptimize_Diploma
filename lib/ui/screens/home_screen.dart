...
class _HomeScreenState extends State<HomeScreen>
  ...
  late UserProfile userProfile; // Declare userProfile as a class-level variable
  ...
  stream: selectedEventType == EventType.userOwned
    ? ooBloc.getUserOwnedEventsSubject
    : selectedEventType == EventType.club
    ? ooBloc.getClubEventsSubject
    : Rx.combineLatest2(
      ooBloc.getUserOwnedEventsSubject,
      ooBloc.getClubEventsSubject,
...
void _showAddEventModal(BuildContext context) {
  ...
  TextEditingController titleController = TextEditingController();
    ...
    int? userProfileId = ooBloc.userProfileSubject.value?.id; // Initialize userProfile
